...
function Home() {
    ...
    const [foodItem, setFoodCItem]=useState([]);
        ...
        <div className="carousel-inner " id='carousel'>
          ...
          <div className="carousel-caption " style={{ zIndex: "10" }}>
            <div className="container-fluid">
              <div className="d-flex mb-7 justify-content-center">
                <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search"  value={search} onChange={(e)=>{setsearch(e.target
                    .value)}}/>
                {/* <button className="btn bg-dark btn-outline-success " style={{ 'color': "white" }} type="submit">Search</button> */}
              </div>
            </div>
          </div>
